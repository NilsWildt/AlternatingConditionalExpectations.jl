...
mysmoother1 = AlternatingConditionalExpectation.LAS(Nk ÷ 5)
...
mysmoothers = Array{Smoother}([mysmoother ])
...
h1 =  benchmark_ace_plot(Benchmark, "Test Smoother Matrix", 80) 